...
public class MapsActivity6 extends Fragment implements OnMapReadyCallback {
    ...
    private Marker addMarkersToMap(DirectionsResult results, GoogleMap mMap, Camion camion) {
    ...
    private Polyline addPolyline(DirectionsResult results, GoogleMap mMap, Camion camion) {
    ...
    private void obtenerRutaOptimaDestino(Camion camion) {
        final LatLng latlng = new LatLng(camion.getUltimaPosicion().getLatitude(), camion.getUltimaPosicion().getLongitude());
        ...
        if (camion.getId().compareTo("357329071346573") == 0) {
            latitudLongitudDestino = "43.533385,-5.844083";
        } else if (camion.getId().compareTo("352166054077352") == 0) {
            try {
                ...
                if (latitudLongitudDestino.compareTo("0.000000,0.000000") == 0) latitudLongitudDestino = "43.572955, -5.934896";
